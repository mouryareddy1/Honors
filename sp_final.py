...
page1=requests.get("http://dla.library.upenn.edu/dla/medren/search.html?fq=collection_facet%3A%22Indic%20Manuscripts%22%20AND%20illustrated_facet%3A%22Yes%22&rows=100")
...
"Geography":""
	...
	#	print fields["Notes"].split(' ')[0]
	#count=0
	#for i in range(len(fields["Notes"])):
	#	if(fields["Notes"][i]=="lines" and fields["Notes"][i+1]=="per"):
	#		count=count+1;
	#print count;
